...
#define MyAppPublisher "Michael Fabian 'Xaymar' Dirks <info@xaymar.com>"
...
; app Information
AppId={{0B94A94D-0C53-4682-9230-587B568F25BF}}
AppName={#MyAppName}
...
AllowNoIcons=yes
LicenseFile="@ISS_SOURCE_DIR@/LICENSE.md"
OutputDir="@ISS_PACKAGE_DIR@"
OutputBaseFilename=@CMAKE_PACKAGE_NAME@-@_PACKAGE_SUFFIX_OVERRIDE@
; Wizard Information
WizardStyle=modern
WizardResizable=yes
SetupIconFile="@PROJECT_SOURCE_DIR@/cmake/templates/PlugIn.ico"
