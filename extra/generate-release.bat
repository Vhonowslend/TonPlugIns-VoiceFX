...
:COMPILE_VST2
    CALL :CMAKE "vst2" -DENABLE_FULL_VERSION=ON -DENABLE_STEINBERG_VST3=OFF -DENABLE_STEINBERG_VST2=ON
    "../build/release/vst2/installer-vst2.iss"    
EXIT /B 0

:COMPILE_VST3
    CALL :CMAKE "vst3" -DENABLE_FULL_VERSION=ON -DENABLE_STEINBERG_VST3=ON -DENABLE_STEINBERG_VST2=OFF
    "../build/release/vst3/installer-vst3.iss"
EXIT /B 0

:COMPILE_VST3_DEMO
    CALL :CMAKE "vst3d" -DENABLE_FULL_VERSION=OFF -DENABLE_STEINBERG_VST3=ON -DENABLE_STEINBERG_VST2=OFF
    "../build/release/vst3d/installer-vst3.iss"
EXIT /B 0
